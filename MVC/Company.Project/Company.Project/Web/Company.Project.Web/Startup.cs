...
namespace Company.Project.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IBookReadingEventAppService, BookReadingEventAppService>();
            services.AddSingleton<IUserRegistrationAppService, UserRegistrationAppService>();
            ...
            services.AddDbContext<BookReadingEventsContext>(options => options.UseSqlServer(Configuration.GetConnectionString("DefaultConnection")), ServiceLifetime.Singleton);
        }
